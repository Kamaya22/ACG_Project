...
public interface ISocialNetwork {
     ...
     *             non-space character</li>
     *             <li>if <code>kind</code> is not instantiated</li>
     *             <li>if <code>director</code> is not instantiated</li>
     *             <li>if <code>scriptwriter</code> is not instantiated</li>
     *             <li>if <code>duration</code> is not strictly positive
     *             </ul>
     * 
     ...
     *             non-space character</li>
     *             <li>if <code>kind</code> is not instantiated</li>
     *             <li>if <code>author</code> is not instantiated</li>
     *             <li>if <code>nbPages</code> is not strictly positive
     *             </ul>
     * 
     * @throws NotMemberException
     *             if <code>login</code> does not match with the login of a registered member
	...
	throws BadEntryException, NotItemException;

    /**
     * An Item is described at least by member's names, book's/film's
     * title/scores and film's titles/scores.
     * 
     * @return a <code>String</code> list containing the name and the kind of the item plus the mean of its marks.
     *         
     */
